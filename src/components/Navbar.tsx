        ...
        <div className=" flex items-center justify-between h-16 ">
          ...
          <div className="relative">
            ...
            <input
              ...
              //w-full working for my Laptop screen size 1024px
            />
          </div>
        </div> */}
          ...
          <form
            ...
            className="relative items-center   hidden lg:block ml-auto mr-4 "
          >
            <button type="submit" className="absolute left-2 top-2 z-10 ">
